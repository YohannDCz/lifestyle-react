  ...
  const getCategoryContent = () => {
    const contentMap = {
      SLEEP: {
        articles: [
          ...
          },
          {
            ...
            image:
              "https://api.builder.io/api/v1/image/assets/TEMP/e522cc4ae8fe3db303abab4412d69b57558f552a?width=640",
          },
        ],
        popular: [
          {
      ...
      MIND: {
        articles: [
          ...
          },
          {
            ...
            category: "Focus",
            image:
              "https://api.builder.io/api/v1/image/assets/TEMP/a9ed354e828f49cccb22a67a888a73248e13aba0?width=640",
          },
        ],
        popular: [
          {
          ...
          {
            title: "Concentration Training Methods",
            category: "Focus",
            image:
              "https://api.builder.io/api/v1/image/assets/TEMP/a9ed354e828f49cccb22a67a888a73248e13aba0?width=640",
          },
      ...
      SOUL: {
        articles: [
          {
            title: "Connecting with Your Inner Self",
        ...
        articles: [
          {
            ...
            category: "Fitness",
            image:
              "https://api.builder.io/api/v1/image/assets/TEMP/fd74e58271b720eeaf18a0bb7349b3c3c9ec26bf?width=640",
          },
          {
      ...
      BRAIN: {
        articles: [
          ...
          {
            title: "Creative Thinking Methods",
            category: "Creativity",
            image:
              "https://api.builder.io/api/v1/image/assets/TEMP/4b3011cc2d2adcb9622b0569f304355c6f3c65e4?width=640",
          },
      ...
      FOOD: {
        articles: [
          ...
          {
            title: "Healthy Recipe Collections",
            category: "Recipes",
            image:
              "https://api.builder.io/api/v1/image/assets/TEMP/fd74e58271b720eeaf18a0bb7349b3c3c9ec26bf?width=640",
          },
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="bg-black h-12 flex items-center justify-between px-6">
        <div className="text-white font-bold text-2xl font-righteous">
          Lifestyle
        </div>
      ...
      <div className="bg-white px-6 lg:px-24">
        ...
        <div className="space-y-20">
          ...
          <div>
            <div className="flex items-center justify-between mb-8">
              <h2 className="text-3xl font-bold text-black">
                Most Popular Articles on {config.title}
              </h2>
              <div className="flex gap-2">
                <button className="w-12 h-12 bg-gray-200 hover:bg-gray-300 rounded-full flex items-center justify-center">
                  <ChevronLeft size={20} />
