...
const Index = () => {
  ...
  const tabs = ['Growth Tracking', 'Expert-led programs', 'AI Guidance', 'Dreams Genesis', 'Mental Reset'];
  ...
  const sleepArticles = [
    ...
    },
    {
      ...
      image: "https://api.builder.io/api/v1/image/assets/TEMP/d6e0ebad917a70f558053bd9d267119197182adf?width=640"
    }
  ];
  ...
  const mindArticles = [
    ...
    },
    {
      ...
      image: "https://api.builder.io/api/v1/image/assets/TEMP/0e1570560c85ecb3ec6227ab0d36582259f4d337?width=640"
    }
  ];
  ...
  const experts = [
    {
      ...
      image: "https://api.builder.io/api/v1/image/assets/TEMP/a0984178998544c162eacbb6ea6be1bbb0227f1d?width=640"
    },
    {
      name: "Dr. Adrian Leclerc",
      description: "Psychologist from Harvard\nCertified OWSLA\nSpecialist in Sleep Health",
      image: "https://api.builder.io/api/v1/image/assets/TEMP/848141448b99503dfad648fd1dc6355ccd595c07?width=640"
    },
    {
      name: "Lama Tenzin Norbu",
      description: "Tibetan Master\nSpecialist in Mind Arts & Visual Thinking",
      image: "https://api.builder.io/api/v1/image/assets/TEMP/22c01e42f78266551811feb74a25354d677081f2?width=640"
    },
    {
      name: "Pr. Isabelle Fournier",
      description: "Professor in technical mnemonic\nGrand Champion of the World Mnemonic Contest in 2014",
      image: "https://api.builder.io/api/v1/image/assets/TEMP/c61e0c48d600823f4cfeccec8429bde48a5da170?width=640"
    }
  ];
          ...
          <div className="max-w-7xl mx-auto px-6">
            <div className="flex flex-wrap gap-4 justify-center">
              {categoryPills.map((pill, index) => (
                <div key={index} className={`bg-gradient-to-r ${pill.colors} rounded-xl px-8 py-3`}>
      ...
      >
        ...
        <div className="relative z-10 text-center text-white max-w-4xl mx-auto px-6">
          <div className="mb-8">
            ...
            <h1 className="font-shrikhand text-6xl md:text-7xl lg:text-8xl mb-4">
              dynamic
            </h1>
            <h1 className="font-roboto text-6xl md:text-7xl lg:text-8xl font-medium">
              energies
            </h1>
          </div>
          
          <p className="text-xl font-medium mb-4 max-w-2xl mx-auto">
            From one habit to an entire routine system. Let lifestyle.com change your life!
          </p>
          
          <p className="text-base mb-8 max-w-2xl mx-auto">
            Lifestyle is lucid dreams, mindfulness, a healthy mental, body & brain, and balanced diet & relationships.
          </p>
          ...
          <div className="relative max-w-4xl mx-auto mb-16">
            <div className="relative w-full aspect-square max-w-2xl mx-auto">
              ...
              <div className="absolute inset-1/4 bg-white rounded-full flex flex-col items-center justify-center text-black">
                <div className="text-center p-8">
                  ...
                  <p className="text-sm leading-relaxed mb-6">
                    your body and mind by prioritizing restful sleep and delving into the fascinating realm of dreams. 
                    Quality sleep restores your energy, boosts cognitive function, and supports emotional balance.
                  </p>
              ...
              <div className="absolute top-0 left-1/2 transform -translate-x-1/2 -translate-y-8">
                <span className="bg-purple-400 text-black px-6 py-2 rounded-full text-lg">Mind</span>
              </div>
              <div className="absolute top-1/4 right-0 transform translate-x-8">
                <span className="bg-pink-400 text-black px-6 py-2 rounded-full text-lg">Mental</span>
              </div>
              <div className="absolute right-0 top-1/2 transform translate-x-8 -translate-y-1/2">
                <span className="bg-red-400 text-black px-6 py-2 rounded-full text-lg">Soul</span>
              </div>
              <div className="absolute bottom-1/4 right-0 transform translate-x-8">
                <span className="bg-orange-400 text-black px-6 py-2 rounded-full text-lg">Body</span>
              </div>
              <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2 translate-y-8">
                <span className="bg-yellow-400 text-black px-6 py-2 rounded-full text-lg">Brain</span>
              </div>
              <div className="absolute bottom-1/4 left-0 transform -translate-x-8">
                <span className="bg-green-400 text-black px-6 py-2 rounded-full text-lg">Food</span>
              </div>
              <div className="absolute left-0 top-1/2 transform -translate-x-8 -translate-y-1/2">
                <span className="bg-cyan-400 text-black px-6 py-2 rounded-full text-lg">Health</span>
              </div>
              <div className="absolute top-1/4 left-0 transform -translate-x-8">
                <span className="bg-blue-400 text-black px-6 py-2 rounded-full text-lg">Sleep</span>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="bg-gradient-to-r from-purple-100 via-pink-100 to-purple-100 rounded-3xl p-8 md:p-12 relative overflow-hidden">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div>
                <h3 className="text-4xl font-semibold mb-6">Track your progress</h3>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-4xl mx-auto">
              From doctors to psychologist, master or even teachers, you'll have the choice to get the next moves. Available in the complete plan.
            </p>
          </div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 text-center text-white">
          ...
          <div className="mb-12">
            <div className="border-4 border-white rounded-full px-8 py-4 inline-flex items-center gap-4 mb-8">
              <div className="flex">
                <img src="https://api.builder.io/api/v1/image/assets/TEMP/35c51fc4e53b41e88b1513ed3f583c91dc267389?width=184" alt="Users" className="w-20 h-8" />
              </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {pricingPlans.map((plan, index) => (
              <div key={index} className="border border-black rounded-3xl p-8 bg-white">
                ...
                <div className="mb-8">
                  <div className="flex items-baseline mb-6">
                    ...
                    <span className="text-xs text-gray-500 ml-2">USD/month</span>
                  </div>
                ...
                <div className="mb-8">
                  <h4 className="text-lg font-medium mb-4">Guaranteed in this plan</h4>
                  <div className="space-y-3">
                    {plan.guarantees.map((guarantee, guaranteeIndex) => (
                      <div key={guaranteeIndex} className="flex items-center gap-3">
                ...
                <button className={`w-full py-4 rounded-full font-medium ${plan.buttonStyle}`}>
                  {plan.buttonText}
                </button>
              </div>
            ))}
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 text-white">
          <div className="grid lg:grid-cols-4 gap-12">
            <div className="lg:col-span-2">
              <div className="mb-8">
                <h3 className="font-roboto text-6xl font-medium mb-2">Website of</h3>
                <h3 className="font-shrikhand text-6xl">energies</h3>
              </div>
              
              {/* Social Media Icons */}
              <div className="flex gap-4 mb-8">
                <img src="https://api.builder.io/api/v1/image/assets/TEMP/433b3c2c2fdc1651876d6448e272cb9e4fc02393?width=158" alt="Instagram" className="w-12 h-12" />
                <img src="https://api.builder.io/api/v1/image/assets/TEMP/d199181698e43581e3becaef5ee0b3c2618a81ec?width=138" alt="Facebook" className="w-12 h-12" />
                <img src="https://api.builder.io/api/v1/image/assets/TEMP/c7eeb7031c9b7fd8d3c39ab9b1b99e935f5e6c2c?width=138" alt="Twitter" className="w-12 h-12" />
                <img src="https://api.builder.io/api/v1/image/assets/TEMP/ce2b5166f8fab3c7a38bd92d7a0bc86e11a47ea6?width=138" alt="YouTube" className="w-12 h-12" />
                <img src="https://api.builder.io/api/v1/image/assets/TEMP/15660308f942849ee97bb806ae67d4f2b9bfd449?width=138" alt="TikTok" className="w-12 h-12" />
              </div>
            </div>
